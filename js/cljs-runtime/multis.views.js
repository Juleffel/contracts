...
var G__54757 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form-value","form-value",-1466863926),path], null);
return (multis.views._LT_sub.cljs$core$IFn$_invoke$arity$1 ? multis.views._LT_sub.cljs$core$IFn$_invoke$arity$1(G__54757) : multis.views._LT_sub.call(null,G__54757));
}),new cljs.core.Keyword(null,"save!","save!",-1137373803),(function (path,value){
var G__54758 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form-set-value","form-set-value",1925489340),path,value], null);
return (multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1 ? multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1(G__54758) : multis.views._GT_evt.call(null,G__54758));
}),new cljs.core.Keyword(null,"doc","doc",1913296891),(function (){
var G__54759 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form-doc","form-doc",873105357)], null);
return (multis.views._LT_sub.cljs$core$IFn$_invoke$arity$1 ? multis.views._LT_sub.cljs$core$IFn$_invoke$arity$1(G__54759) : multis.views._LT_sub.call(null,G__54759));
})], null);
multis.views.form_new_recipient_template = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),(function (p1__54760_SHARP_){
p1__54760_SHARP_.preventDefault();

var G__54761 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app","form-submit-new-recipient","app/form-submit-new-recipient",2015349978)], null);
return (multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1 ? multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1(G__54761) : multis.views._GT_evt.call(null,G__54761));
...
multis.views.account_row = (function multis$views$account_row(p__54762,selected_key){
var map__54763 = p__54762;
var map__54763__$1 = (((((!((map__54763 == null))))?(((((map__54763.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54763.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54763):map__54763);
var address = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54763__$1,new cljs.core.Keyword(null,"address","address",559499426));
var eth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54763__$1,new cljs.core.Keyword(null,"eth","eth",1381694970));
...
var selected_address = (function (){var G__54765 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form-value","form-value",-1466863926),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [selected_key], null)], null);
return (multis.views._LT_sub.cljs$core$IFn$_invoke$arity$1 ? multis.views._LT_sub.cljs$core$IFn$_invoke$arity$1(G__54765) : multis.views._LT_sub.call(null,G__54765));
})();
...
var G__54766 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form-set-value","form-set-value",1925489340),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [selected_key], null),address], null);
return (multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1 ? multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1(G__54766) : multis.views._GT_evt.call(null,G__54766));
...
var temp__5733__auto__ = (function (){var G__54767 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-accounts","user-accounts",-1069398958)], null);
return (multis.views._LT_sub.cljs$core$IFn$_invoke$arity$1 ? multis.views._LT_sub.cljs$core$IFn$_invoke$arity$1(G__54767) : multis.views._LT_sub.call(null,G__54767));
})();
...
var accounts = (function (){var G__54768 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"recipient-accounts","recipient-accounts",235535329)], null);
return (multis.views._LT_sub.cljs$core$IFn$_invoke$arity$1 ? multis.views._LT_sub.cljs$core$IFn$_invoke$arity$1(G__54768) : multis.views._LT_sub.call(null,G__54768));
})();
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form.stream-form","form.stream-form",-591305450),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),(function (p1__54769_SHARP_){
p1__54769_SHARP_.preventDefault();

var G__54770 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app","form-submit-create-stream","app/form-submit-create-stream",-62708770)], null);
return (multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1 ? multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1(G__54770) : multis.views._GT_evt.call(null,G__54770));
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.stream-form__title","div.stream-form__title",180736488),"Stream tokens"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_forms.core.bind_fields,multis.views.stream_form_template,multis.views.form_events], null),(function (){var stream_valid_QMARK_ = (function (){var G__54771 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"stream-values-valid?","stream-values-valid?",497467954)], null);
return (multis.views._LT_sub.cljs$core$IFn$_invoke$arity$1 ? multis.views._LT_sub.cljs$core$IFn$_invoke$arity$1(G__54771) : multis.views._LT_sub.call(null,G__54771));
})();
...
var G__54772 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app","load-accounts","app/load-accounts",-358575003)], null);
return (multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1 ? multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1(G__54772) : multis.views._GT_evt.call(null,G__54772));
...
var G__54773 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app","deploy-db-contract","app/deploy-db-contract",-1383277046),"test"], null);
return (multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1 ? multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1(G__54773) : multis.views._GT_evt.call(null,G__54773));
...
var G__54774 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app","test-rectangle-estimate","app/test-rectangle-estimate",-1465758043),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),(2),new cljs.core.Keyword(null,"height","height",1025178622),(3)], null)], null);
return (multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1 ? multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1(G__54774) : multis.views._GT_evt.call(null,G__54774));
...
var G__54775 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app","test-rectangle","app/test-rectangle",2060395263),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),(2),new cljs.core.Keyword(null,"height","height",1025178622),(3)], null)], null);
return (multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1 ? multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1(G__54775) : multis.views._GT_evt.call(null,G__54775));
...
var G__54776 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app","get-accounts-contracts","app/get-accounts-contracts",-2059806885)], null);
return (multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1 ? multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1(G__54776) : multis.views._GT_evt.call(null,G__54776));
...
var G__54777 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app","sablier-create-stream","app/sablier-create-stream",1793081846),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"from","from",1815293044),"0x681FbA7ceF62673C01184cFa832CE3CE298d7e86",new cljs.core.Keyword(null,"to","to",192099007),"0x8d8ddefafdf23feea24a6de9b3940ea6e5f54a3d",new cljs.core.Keyword(null,"deposit","deposit",-1686435851),"60000",new cljs.core.Keyword(null,"start-time","start-time",814801386),(multis.views.now() + (120)),new cljs.core.Keyword(null,"stop-time","stop-time",-749575378),((multis.views.now() + (120)) + (60))], null)], null);
return (multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1 ? multis.views._GT_evt.cljs$core$IFn$_invoke$arity$1(G__54777) : multis.views._GT_evt.call(null,G__54777));
