...
var G__41400 = devtools.prefs.pref(v);
v = G__41400;
continue;
} else {
return v;
...
}catch (e41323){var _e__39975__auto__ = e41323;
return false;
}})();
...
}catch (e41331){var _e__39975__auto__ = e41331;
return false;
}})();
...
}catch (e41339){var _e__39975__auto__ = e41339;
return false;
}}
}
});
...
var vec__41367 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41367,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41367,(1),null);
...
return cljs.core.some((function (p1__41377_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41377_SHARP_);
}),template);
});
