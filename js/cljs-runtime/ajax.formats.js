...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__52962){
...
var request = map__52963__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52963__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__52967 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__52967.cljs$core$IFn$_invoke$arity$1 ? fexpr__52967.cljs$core$IFn$_invoke$arity$1(response) : fexpr__52967.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__52968 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__52968.cljs$core$IFn$_invoke$arity$1 ? fexpr__52968.cljs$core$IFn$_invoke$arity$1(response) : fexpr__52968.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__52969){
...
var request = map__52970__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52970__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
