...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__53677){
...
var request = map__53678__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53678__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__53682 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__53682.cljs$core$IFn$_invoke$arity$1 ? fexpr__53682.cljs$core$IFn$_invoke$arity$1(response) : fexpr__53682.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__53683 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__53683.cljs$core$IFn$_invoke$arity$1 ? fexpr__53683.cljs$core$IFn$_invoke$arity$1(response) : fexpr__53683.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__53684){
var map__53685 = p__53684;
var map__53685__$1 = (((((!((map__53685 == null))))?(((((map__53685.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53685.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53685):map__53685);
var request = map__53685__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53685__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
