...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__45873_SHARP_,p2__45874_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__45873_SHARP_,p2__45874_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function re_com$tour$initialise_tour_$_iter__45891(s__45892){
return (new cljs.core.LazySeq(null,(function (){
var s__45892__$1 = s__45892;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__45892__$1);
if(temp__5735__auto__){
var s__45892__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__45892__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__45892__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__45894 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__45893 = (0);
while(true){
if((i__45893 < size__4581__auto__)){
var step = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__45893);
cljs.core.chunk_append(b__45894,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__45968 = (i__45893 + (1));
i__45893 = G__45968;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45894),re_com$tour$initialise_tour_$_iter__45891(cljs.core.chunk_rest(s__45892__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45894),null);
}
} else {
var step = cljs.core.first(s__45892__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__45891(cljs.core.rest(s__45892__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__45914 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__45914.cljs$core$IFn$_invoke$arity$1 ? fexpr__45914.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__45914.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__45921 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__45921.cljs$core$IFn$_invoke$arity$1 ? fexpr__45921.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__45921.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__45923 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__45923.cljs$core$IFn$_invoke$arity$1 ? fexpr__45923.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__45923.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__45932 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__45932.cljs$core$IFn$_invoke$arity$1 ? fexpr__45932.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__45932.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__45933 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__45933.cljs$core$IFn$_invoke$arity$1 ? fexpr__45933.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__45933.call(null,tour));
})(),true);
} else {
return null;
}
